                    ...
                    <div class="mb-0 shadow-sm card rounded-8">
                        <div class="card-header card-header-action"
                            ...
                            <h6 class="mb-0">Services <span
                                    class="badge bg-light text-dark ms-1">{{ $expense_sources->count() }}</span></h6>
                        </div>
                        <div class="card-body">
                            {{-- Alert Messages --}}
                            @if ($errors->any())
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar avatar-sm avatar-rounded avatar-info me-2">
                                                            <span
                                                                class="initial-wrap">{{ substr($expense_source->name, 0, 1) }}</span>
                                                        </div>
                                                        <div>
                                                            <span class="fw-medium">{{ $expense_source->name }}</span>
                                                                ...
                                                                <button
                                                                    ...
                                                                    <span class="icon">
                                                                        <span class="feather-icon"
                                                                            ...
                                                                            data-bs-target="#deleteModal{{ $expense_source->id }}"><i
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <span>{{ $expense_source->details }}</span>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <input type="checkbox" class="toggle-status"
                                                            data-toggle="toggle" data-id="{{ $expense_source->id }}"
                                                            {{ $expense_source->is_active ? 'checked' : '' }}>
                                                    </div>
                                                </td>
                                                <td>
                                                    <span class="feather-icon" data-bs-toggle="modal"
                                                        data-bs-target="#updatemodel{{ $expense_source->id }}"><i
