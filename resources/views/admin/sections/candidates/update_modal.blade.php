                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <input type="email" name="email" id="email-{{ $candidate->id }}" class="form-control"
                                value="{{ $candidate->email }}" required>
                        </div>

                        <div class="col-12">
                            <label for="phone-{{ $candidate->id }}" class="form-label">Phone</label>
                            <input type="text" name="phone" id="phone-{{ $candidate->id }}" class="form-control"
                        ...
                        <div class="col-12">
                            ...
                            <select name="country" id="country-{{ $candidate->id }}" class="form-select" required>
                                ...
                                <option value="Egypt" {{ $candidate->country == 'Egypt' ? 'selected' : '' }}>Egypt
                                </option>
                                <option value="United States"
                                    {{ $candidate->country == 'United States' ? 'selected' : '' }}>United States
                                </option>
                                <option value="United Kingdom"
                                    {{ $candidate->country == 'United Kingdom' ? 'selected' : '' }}>United Kingdom
                                </option>
                                <option value="Canada" {{ $candidate->country == 'Canada' ? 'selected' : '' }}>Canada
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="file" name="image" id="image" class="form-control"
                                accept="image/*">
                            <div class="mt-2">
                                <a href="{{ $candidate->getFirstMediaUrl('candidate_images') }}" target="_blank"
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="file" name="cv" id="cv" class="form-control"
                                accept=".pdf,.doc,.docx">
                            <div class="mt-2">
                                <a href="{{ $candidate->getFirstMediaUrl('candidate_cv') }}" target="_blank"
                                    class="btn btn-outline-primary btn-sm">
                                    View Candidate CV
                                </a>
                            </div>
