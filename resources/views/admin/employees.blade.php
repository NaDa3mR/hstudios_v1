                ...
                <div class="taskboardapp-wrap">
                    <div class="taskboardapp-content">
                        <div class="taskboardapp-detail-wrap">
                            @include('admin.sections.employees.topbar')
                            @section('blog-header-action')
                            @endsection

                            @include('admin.sections.employees.table')
                        </div>

                        @include('admin.sections.employees.add_modal')
                        @foreach ($employees as $employee)
                            @include('admin.sections.employees.update_modal')
                            @include('admin.sections.employees.delete_modal')
                        @endforeach
                    </div>
                </div>
            </div>
