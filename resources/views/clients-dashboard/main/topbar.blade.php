@switch( request()->url() )
    @case(route('contacts.index'))
        @include('clients-dashboard.sections.contacts.topbar')
        @break
    @case(route('deals.index'))
        @include('clients-dashboard.sections.deals.topbar')
        @break
    @case(route('pipelines.index'))
        @include('clients-dashboard.sections.pipelines.topbar')
        @break
    @case(route('deals.show', ['id' => isset( $pipeline->id)? $pipeline->id : '']))
        @include('clients-dashboard.sections.deals.topbar')
        @break
    @default
