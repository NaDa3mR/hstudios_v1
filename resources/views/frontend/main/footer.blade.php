                    ...
                    <div class="footer-contact-wrap">
                        ...
                        <ul class="contact-list">
                            <li class="single-contact">
                                <div class="icon">
                                    <img src={{ asset('website-assets/img/home1/icon/contact-call-icon.svg') }}
                                        alt="">
                                </div>
                                <div class="content">
                                    <span>Call 24/7 Hours</span>
                                    <a href="tel:
                                    +201151948786">+201151948786</a>
                                </div>
                            </li>
                            <li class="single-contact">
                                <div class="icon">
                                    <img src="{{ asset('website-assets/img//home1/icon/contact-mail-icon.svg') }}"
                                        alt="">
                                </div>
                                <div class="content">
                                    <span>Send Us Mail</span>
                                    <a
                                        href="https://demo.egenslab.com/cdn-cgi/l/email-protection#375e59515877524f565a475b521954585a"><span
                                            class="__cf_email__"
