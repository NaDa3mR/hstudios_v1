...
<header class="header-area style-1">
    <div class="container-xl container-fluid d-flex flex-nowrap align-items-center justify-content-between">
        <div class="company-logo-and-contact-area">
            <div class="company-logo">
                <a href="index.html" class="logo-dark"><img alt="image" class="img-fluid" src="{{ asset('website-assets/img/header-logo.svg') }}"></a>
                <a href="index.html" class="logo-light"><img alt="image" class="img-fluid" src="{{ asset('website-assets/img/header-logo-white.svg') }}"></a>
            </div>
            <div class="contact-area d-lg-flex d-none">
                <div class="icon">
                    <img src="{{ asset('website-assets/img/home1/icon/support-icon.svg') }}" alt="">
                </div>
                <div class="content">
        ...
        <div class="menu-and-btn-area">
            <div class="main-menu">
                <div class="mobile-logo-area d-lg-none d-flex align-items-center justify-content-between">
                    <a href="index.html" class="mobile-logo-wrap">
                        <img alt="image" class="img-fluid light" src="{{ asset('website-assets/img/header-logo.svg') }}">
                        <img alt="image" class="img-fluid dark" src="{{ asset('website-assets/img/header-logo-white.svg') }}">
                    </a>
                ...
                <ul class="menu-list">
                                ...
                                <div class="row gy-5">
                                    <div class="col-lg-3">
                                        <div class="single-menu-item active">
                                            <div class="home-img">
                                                <img src="{{ asset('website-assets/img/home1/mega-menu-home-img1.jpg') }}" alt="">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="single-menu-item">
                                            <div class="home-img">
                                                <img src="{{ asset('website-assets/img/home1/mega-menu-home-img2.jpg') }}" alt="">
                                                <div class="home-version">
                                                    <ul>
                                                        <li>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="single-menu-item">
                                            <div class="home-img">
                                                <img src="{{ asset('website-assets/img/home1/mega-menu-home-img3.jpg') }}" alt="">
                                                <div class="home-version">
                                                    <ul>
                                                        <li>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="single-menu-item">
                                            <div class="home-img">
                                                <img src="{{ asset('website-assets/img/home1/mega-menu-home-img4.jpg') }}" alt="">
                                                <div class="home-version">
                                                    <ul>
                                                        <li>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="single-menu-item">
                                            <div class="home-img">
                                                <img src="{{ asset('website-assets/img/home1/mega-menu-home-img5.jpg') }}" alt="">
                                                <div class="home-version">
                                                    <ul>
                                                        <li>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="single-menu-item">
                                            <div class="home-img">
                                                <img src="{{ asset('website-assets/img/home1/mega-menu-home-img6.jpg') }}" alt="">
                                                <div class="home-version">
                                                    <ul>
                                                        <li>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="single-menu-item">
                                            <div class="home-img">
                                                <img src="{{ asset('website-assets/img/home1/mega-menu-home-img7.jpg') }}" alt="">
                                                <div class="home-version">
                                                    <ul>
                                                        <li>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="single-menu-item">
                                            <a href="#" class="home-img">
                                                <img src="{{ asset('website-assets/img/home1/mega-menu-home-img8.jpg') }}" alt="">
                                            </a>
                    ...
                    <li class="menu-item-has-children position-inherit">
                        <a href="service.html" class="drop-down">Solution
                        </a>
                        <i class="bi bi-plus dropdown-icon"></i>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="solution-menu-banner">
                                            ...
                                            <div class="banner-img">
                                                <img src="{{ asset('website-assets/img/home1/solution-menu-banner-img.png') }}" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <li class="menu-item-has-children">
                        <a href="portfolio-classic.html" class="drop-down">Portfolio</a>
                        <i class="bi bi-plus dropdown-icon"></i>
                        <ul class="sub-menu">
                    ...
                    <li class="menu-item-has-children position-inherit">
                        <a href="#" class="drop-down">Resources</a>
                        <i class="bi bi-plus dropdown-icon"></i>
                                    ...
                                    <div class="col-xl-6 col-lg-7 d-lg-block d-none">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="menu-blog-card">
                                                    <a href="news-insight-details.html" class="blog-img">
                                                        <img src="{{ asset('website-assets/img/home1/menu-blog-img1.jpg') }}" alt="">
                                                    </a>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="menu-blog-card">
                                                    <a href="news-insight-details.html" class="blog-img">
                                                        <img src="{{ asset('website-assets/img/home1/menu-blog-img2.jpg') }}" alt="">
                                                    </a>
                                                    <div class="blog-content">
                                                        <ul class="blog-meta">
                                                            <li>
            ...
            <div class="nav-right">
                <a href="contact.html" class="primary-btn1 d-lg-flex d-none">
                    <span>Contact
                        <svg width="10" height="10" viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
                            <path d="M1 9L9 1M9 1C7.22222 1.33333 3.33333 2 1 1M9 1C8.66667 2.66667 8 6.33333 9 9" stroke-width="1.5" stroke-linecap="round" />
                        </svg>
