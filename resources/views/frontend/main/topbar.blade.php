    ...
    <div class="container-xl container-fluid d-flex flex-nowrap align-items-center justify-content-between">
        <div class="company-logo-and-contact-area">
            <div class="company-logo">
                <a href="{{ route('home') }}" class="logo-dark"><img alt="image" class="img-fluid"
                        src="{{ asset('website-assets/logo.png') }}" style="width:150px;"></a>
        ...
        <div class="menu-and-btn-area">
            <div class="main-menu">
                <div class="mobile-logo-area d-lg-none d-flex align-items-center justify-content-between">
                    <a href="{{ route('home') }}" class="mobile-logo-wrap">
                        <img alt="image" class="img-fluid light"
                            src="{{ asset('website-assets/img/header-logo.svg') }} ">
                        <img alt="image" class="img-fluid dark"
                            src="{{ asset('website-assets/img/header-logo-white.svg') }}">
                    </a>
                ...
                <ul class="menu-list">
                    <li class="position-inherit active">
                        <a href="{{ route('home') }}">
                            Home</a>
                    </li>
                                        ...
                                        <ul class="menu-row">
                                            ...
                                            {{-- <li class="menu-single-item">
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="industry-details.html">Government & Public Sector</a>
                                                    </li>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="solution-menu-banner">
                                            ...
                                            <div class="banner-img">
                                                <img src="{{ asset('website-assets/img/home1/solution-menu-banner-img.png') }}"
                                                    alt="">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6 col-lg-7 d-lg-block d-none">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="menu-blog-card">
                                                    <a href="news-insight-details.html" class="blog-img">
                                                        <img src="{{ asset('website-assets/img/home1/menu-blog-img1.jpg') }}"
                                                            alt="">
                                                    </a>
                                                    <div class="blog-content">
                                                            ...
                                                            <li>
                                                                <a href="news-insight-grid.html">
                                                                    <svg width="8" height="8"
                                                                        ...
                                                                        <g>
                                                                            <path
                                                                                d="M0.800781 8V0L7.20078 4L0.800781 8Z" />
                                                                        </g>
                                                                    </svg>
                                                                    IT Strategy
                                                                </a>
                                                        ...
                                                        <h5><a href="news-insight-details.html">Revamping Brand
                                                                Identity Success Story.</a></h5>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="menu-blog-card">
                                                    <a href="news-insight-details.html" class="blog-img">
                                                        <img src="{{ asset('website-assets/img/home1/menu-blog-img2.jpg') }}"
                                                            alt="">
                                                    </a>
                                                    <div class="blog-content">
                                                        <ul class="blog-meta">
                                                        ...
                                                        <h5><a href="news-insight-details.html">Cloud Infrastructure
                                                                for Rapid Growth.</a></h5>
                                                        <a href="news-insight-details.html" class="read-more-btn">
                                                            Read More
                                                            <svg width="10" height="10" viewBox="0 0 10 10"
                                                                xmlns="http://www.w3.org/2000/svg">
            ...
            {{-- <div class="nav-right d-flex align-items-center">
                ...
                <a href="{{ route('contact.create') }}" class="primary-btn2 d-lg-flex d-none">
                    <span>Contact
                        <svg width="10" height="10" viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
