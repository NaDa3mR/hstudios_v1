            ...
            <div class="row justify-content-center">
                <div class="col-xl-8 col-lg-10">
                    <div class="banner-content">
                        <ul class="blog-meta">
                            <li><a href="{{ route('blog.showAll') }}">All Blogs</a></li>
                            <li>
                        ...
                        <ul class="breadcrumb-list">
                            <li><a href="https://demo.egenslab.com/">Home</a></li>
                            <li>
        ...
        <div class="container">
            <div class="details-content-wrap">
                <div class="post-thumb mb-70">
                    <img src="{{ $blog->getFirstMediaUrl('blog_images') }}" alt="Blog Image" class="fixed-img">
                </div>
                <div class="row justify-content-center">
                    <div class="col-xl-8 col-lg-10">
                        <h2>{{ $blog->title }}</h2>
                        ...
                        <blockquote>
                            ...
                            <svg class="quote" width="100" height="74" viewBox="0 0 100 74"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        <span class="line-break"></span>
                        <span class="line-break"></span>
                        <p>As smartphones became ubiquitous, the focus shifted to mobile-friendly websites, apps, and
                            mobile-optimized content. Mobile commerce (m-commerce) surged, with businesses needing to
                            adapt to consumers' increasing preference for shopping and browsing on their phones.</p>
                    </div>
                </div>
                <span class="line-break"></span>
                <span class="line-break"></span>
                                ...
                                <li>
                                    ...
                                    <ul class="comment-replay">
                                        <li>
                                            <div class="single-comment-area">
                                                <div class="author-img">
                                                    <img src="assets/img/innerpages/comment-author-02.jpg"
                                                        alt="">
                                                </div>
                                                <div class="comment-content">
                                                    <div class="author-name-deg">
                        ...
                        <div class="details-pagination two">
                            ...
                            @if ($previous)
                                <div class="single-pagination">
                                    <a class="pagination-btn" href="{{ route('blog.showSingle', $previous->id) }}">
                                    ...
                                    <div class="content">
                                        <h6>
                                            <a href="{{ route('blog.showSingle', $previous->id) }}">
                                                {{ $previous->title }}
                                            </a>
                                        </h6>
                                    </div>
                            ...
                            @if ($next)
                                <div class="single-pagination two text-end">
                                    <div class="content">
                                        <h6>
                                            <a href="{{ route('blog.showSingle', $next->id) }}">
                                                {{ $next->title }}
                                            </a>
                                        </h6>
                                    </div>
                                    <a class="pagination-btn" href="{{ route('blog.showSingle', $next->id) }}">
