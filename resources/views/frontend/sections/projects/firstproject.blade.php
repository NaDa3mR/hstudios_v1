...
<body>
    ...
    <div class="case-study-details-page mb-130">
        <div class="container">
            <div class="row gy-5">
                <div class="col-lg-8">
                    <div class="details-content-wrap">
                        <div class="post-thumb two mb-70">
                            <img src="{{ asset('website-assets/img/innerpages/case-study-details-thumb-img.jpg') }}"
                                alt="">
                        </div>
                        ...
                        <p>Brightwave Electronics, a mid-sized electronics manufacturer specializing in eco-friendly
                            consumer devices, faced challenges in connecting with its audience due to an outdated brand
                            image. The company wanted a brand identity that reflected its commitment to innovation and
                            sustainability.</p>
                        <span class="line-break"></span>
                        <span class="line-break"></span>
                        <span class="line-break"></span>
                        <h2>Challenges</h2>
                        <span class="line-break"></span>
                        <ul class="listing three">
                            <li><span>Outdated Brand Perception:</span> The company was perceived as traditional and
                                conservative, which didn’t align with its eco-friendly and innovative product lines.
                            </li>
                            <li><span>Lack of Brand Differentiation:</span> In a competitive market, the existing brand
                                lacked elements that set it apart from other players.</li>
                        </ul>
                        <span class="line-break"></span>
                        <span class="line-break"></span>
                        <span class="line-break"></span>
                        ...
                        <span class="line-break"></span>
                        <ul class="listing three">
                            <li><span>Rebranding for Alignment:</span> Ensuring the brand identity matched company
                                values attracted a loyal, aligned customer base.</li>
                            <li><span>Employee Involvement:</span> Employees play a crucial role in successful
                                rebranding, as they embody the brand’s values.</li>
                        </ul>
                        <span class="line-break"></span>
                        <span class="line-break"></span>
                        <span class="line-break"></span>
                        <div class="img-grp mb-130">
                            <div class="row g-4">
                                <div class="col-xl-8 col-md-7">
                                    <img src="{{ asset('website-assets/img/innerpages/case-study-details-img1.jpg') }}"
                                        alt="">
                                </div>
                                <div class="col-xl-4 col-md-5">
                                    <img src="{{ asset('website-assets/img/innerpages/case-study-details-img2.jpg') }}"
                                        alt="">
                                </div>
                            </div>
                        </div>
                        {{-- <div class="details-pagination">
                            <div class="single-pagination">
                                <a class="pagination-btn" href="news-insight-details.html">
                                    <img src="{{ asset('website-assets/img/innerpages/details-pagination-btn-bg5.png') }}"
                                        alt="">
                                ...
                                <div class="content">
                                    <h6><a href="news-insight-details.html">Crafting a Seamless Digital Presence for DEF
                                            Technology.</a></h6>
                                </div>
                            </div>
                            <div class="single-pagination two text-end">
                                <div class="content">
                                    <h6><a href="news-insight-details.html">Increasing Lead Generation Through
                                            Campaigns.</a></h6>
                                </div>
                                <a class="pagination-btn" href="news-insight-details.html">
                ...
                <div class="col-lg-4">
                    <div class="case-study-details-sidebar">
                            ...
                            <ul class="download-btns">
                                <li>
                                    <a href="assets/company-desk.pdf" download="company-desk.pdf"
                                        class="primary-btn3 btn-hover">
                                        <img src="{{ asset('website-assets/img/innerpages/icon/pdf-icon2.svg') }}"
                                            alt="">
                                        Download Pdf
                                        <span></span>
                                    </a>
                                ...
                                <li>
                                    <a href="{{ asset('website-assets/company-desk.pdf') }}"
                                        download="company-desk.pdf" class="primary-btn3 two btn-hover">
                                        Download Docs
                        ...
                        <div class="note-area">
                            ...
                            <div class="content">
                                <p><span>Increased Brand Awareness:</span> Following the rebrand, Brightwave reported a
                                    <span>35% increase</span> in brand recognition and media mentions.</p>
                                <ul>
                                    <li>
                                        <h6>
                                            <svg width="10" height="10" viewBox="0 0 10 10"
