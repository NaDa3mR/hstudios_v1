...
$(function() {
    ...
    var targetDt3 = $('#datable_booking_online_upcoming').DataTable({
        scrollX:  true,
        autoWidth: false,
        dom: 'Bfrtip',
        "columnDefs": [ {
    ...
    $('#datable_booking_online_upcoming_wrapper .dataTables_filter').addClass('float-end');
	$('#datable_booking_online_upcoming_wrapper .dt-buttons > .btn').addClass('btn-outline-light btn-sm');

    var targetDt4 = $('#datable_booking_offline_upcoming').DataTable({
		scrollX:  true,
		autoWidth: false,
		dom: 'Bfrtip',
		"columnDefs": [ {
    ...
    $('#datable_booking_offline_upcoming_wrapper .dataTables_filter').addClass('float-end');
	$('#datable_booking_offline_upcoming_wrapper .dt-buttons > .btn').addClass('btn-outline-light btn-sm');

    var targetDt5 = $('#datable_booking_history').DataTable({
		scrollX:  true,
		autoWidth: false,
		dom: 'Bfrtip',
		"columnDefs": [ {
    ...
    $('#datable_booking_history_wrapper .dataTables_filter').addClass('float-end');
	$('#datable_booking_history_wrapper .dt-buttons > .btn').addClass('btn-outline-light btn-sm');
